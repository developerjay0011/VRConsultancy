            ...
            <div>
              ...
              <ul className="space-y-2">
                {companyLinks.map((link) => (
                  <li key={link.name}>
                    <Link href={link.href} className="text-sm text-white-200 hover:text-primary transition-colors">
                      {link.name}
                    </Link>
                  </li>
                ))}
                ...
                <div className="space-y-2">
                  {loanTypes.primary.map((loan) => (
                    <Link
                      key={loan.name}
                      href={loan.href}
                      className="block text-sm text-white-200 hover:text-primary transition-colors"
                    >
                      {loan.name}
                    </Link>
                  ))}
            ...
            <div className="flex flex-wrap items-center justify-between gap-8">
              {[
                ...
                <motion.div key={partner.name} whileHover={{ scale: 1.05 }}>
                  <Image
                    src={`/${partner.name.toLowerCase().replace(' ', '')}.png`}
                    alt={partner.name}
                    width={partner.width}
                    height={40}
